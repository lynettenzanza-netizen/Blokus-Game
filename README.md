...
## Features
- 2–4 player support
- Graphical (GUI) and command line interfaces
...
- Computer player with two difficulty modes:
  ...
  - **Hard** — prioritizes placing the largest pieces first and works towards
...
- Java
- Java Swing / AWT
- Java Serialization (for save/load functionality)

## Team
This project was developed and presented by a team of 4 students.
Individual contributions:
- **[Your Name]** — Game UI design, core game logic, save/load system using
  Java serialization, and co-development of the computer player algorithm
- 3 collaborating team members
